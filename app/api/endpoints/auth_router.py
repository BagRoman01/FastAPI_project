...
from app.api.dependencies import users_service_dep
...
async def login_user(user: UserLogin, user_service: users_service_dep, response: Response):
    return await user_service.authenticate_user(user, response=response)
